...
_G.Color = Color3.fromRGB(15, 189, 242)
...
Title.Text = "Ui Old ".."<font color='rgb(178, 102, 255)'></font>".."| "..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
Title.RichText = true;
...
Text2.Text = "Join Penguin Hub Discord!"
...
Textbtn2.MouseButton1Click:Connect(function()
  ...
  setclipboard("https://discord.gg/pAmAvTZxad")
  end)
